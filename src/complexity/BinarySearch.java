...
public class BinarySearch {
    ...
    // O(n / 2) = O(log(n)) - logarithmic - time
    ...
    private static int binarySearchTailRecursive(int elem, int[] arr, int start, int finish) {
        ...
        else if (elem < arr[middle]) return binarySearchTailRecursive(elem, arr, start, middle - 1);
        else return binarySearchTailRecursive(elem, arr, middle + 1, finish);
    }
